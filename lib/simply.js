/*!
 * SimplyJS JavaScript Library v0.1 [pre-alpha; unstable]
 * Date: 2014-04-24 14:09
 *
...
var $ = function(query, root) {
	if (query.indexOf("#") === 0) { return $.gel(query.slice(1)); }
 ...
 * @param {function || string} [func] function that will be executed as a listener || string reference to the function
 ...
 * @param {string || object} [b] Added className || associative array with properties for element attributes
 * @param {object} [doc] parent context document (default: document)
 * @returns {node}
 */
$.cel = function(tagName, b, doc, styles) {
	var d = doc || document;
