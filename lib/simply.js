/*!
 * SimplyJS JavaScript Library v0.2.4 [pre-alpha; unstable]
 * Date: 2014-05-29 12:24
 *
...
$.addClass = function(elm, className) {
	...
	if (typeof(className) == "string") {
		...
		className.forEach(function(cn2) {
			if (typeof(cn2) != "string") {
 ...
 * @param {Object} [element] DOM node
 * @param {string||array} [className] CSS class
 */
