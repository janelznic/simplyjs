/*!
 * SimplyJS JavaScript Library v0.3.8 [alpha; unstable]
...
var $ = function(query, root) {
	if (/^#[$A-Z_][0-9A-Z-_$]*$/i.test(query) === true) {
		return $.gel(query.slice(1));
	}
...
/**
 * Merge objects
 * @param {object} [arguments] ...Objects
 ...
 * @param {whatever} [value] Input value
 * @returns {string} type of input value
 */
